...
<body>
    <main class="container mt-4">
        <section class="principal">
            ...
            <a href="cadastro_clientes.php" class="btn btn-primary mb-3">Cadastrar Cliente</a><br>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="edita_cliente.php?cod_cliente=<?php echo $cliente['cod_cliente']; ?>" class="btn btn-sm btn-warning">Editar</a>
